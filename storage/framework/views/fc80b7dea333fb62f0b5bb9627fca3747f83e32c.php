...
<?php $__env->startSection('title', 'Tagihan Murid'); ?>
...
<div style="width: 100%;">
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 13px; white-space: nowrap;">
            ...
            <tbody id="tagihanTableBody">
                ...
                <tr style="border-bottom: 1px solid #F3F4F6;">
                    ...
                    <td style="padding: 15px; text-align: center;"><?php echo $t->status_pendaftaran == 'Lunas' ? '<span style="padding:5px 12px;border-radius:20px;background:#E1F7E3;color:#0E7490;">Lunas</span>' : '<span style="padding:5px 12px;border-radius:20px;background:#FEE2E2;color:#EF4444;">Belum</span>'; ?></td>
                    <td style="padding: 15px; text-align: center;"><?php echo $t->status_pembayaran == 'Lunas' ? '<span style="padding:5px 12px;border-radius:20px;background:#E1F7E3;color:#0E7490;">Lunas</span>' : ($t->status_pembayaran == 'Belum' ? '<span style="padding:5px 12px;border-radius:20px;background:#FEE2E2;color:#EF4444;">Belum</span>' : '-'); ?></td>
                    <td style="padding: 15px; text-align: center;"><?php echo $t->status_tagihan == 'Lunas' ? '<span style="padding:5px 12px;border-radius:20px;background:#E1F7E3;color:#0E7490;">Lunas</span>' : ($t->status_tagihan == 'Tunggak' ? '<span style="padding:5px 12px;border-radius:20px;background:#FEF3C7;color:#92400E;">Tunggak</span>' : ($t->status_tagihan == 'Uang Muka' ? '<span style="padding:5px 12px;border-radius:20px;background:#E0E7FF;color:#4338CA;">Uang Muka</span>' : '-')); ?></td>
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 20px; padding: 0 5px;">
        ...
        <div style="display: flex; gap: 5px;">
            ...
            <?php else: ?>
                <a href="<?php echo e($tagihan->url(1)); ?>&per_page=<?php echo e(request('per_page', 10)); ?>" style="width: 35px; height: 35px; border-radius: 8px; border: 1px solid #E5E7EB; background: white; color: #374151; display: flex; align-items: center; justify-content: center; text-decoration: none;"><i class="fas fa-angle-double-left"></i></a>
                <a href="<?php echo e($tagihan->previousPageUrl()); ?>&per_page=<?php echo e(request('per_page', 10)); ?>" style="width: 35px; height: 35px; border-radius: 8px; border: 1px solid #E5E7EB; background: white; color: #374151; display: flex; align-items: center; justify-content: center; text-decoration: none;"><i class="fas fa-angle-left"></i></a>
            <?php endif; ?>
            ...
            <?php for($i = $start; $i <= $end; $i++): ?>
                ...
                <?php else: ?>
                    <a href="<?php echo e($tagihan->url($i)); ?>&per_page=<?php echo e(request('per_page', 10)); ?>" style="width: 35px; height: 35px; border-radius: 8px; border: 1px solid #E5E7EB; background: white; color: #374151; display: flex; align-items: center; justify-content: center; text-decoration: none;"><?php echo e($i); ?></a>
                <?php endif; ?>
            <?php endfor; ?>

            <?php if($tagihan->hasMorePages()): ?>
                <a href="<?php echo e($tagihan->nextPageUrl()); ?>&per_page=<?php echo e(request('per_page', 10)); ?>" style="width: 35px; height: 35px; border-radius: 8px; border: 1px solid #E5E7EB; background: white; color: #374151; display: flex; align-items: center; justify-content: center; text-decoration: none;"><i class="fas fa-angle-right"></i></a>
            <?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Privat-Bimbel\resources\views/dashboard/shared/pembayaran/tagihan.blade.php ENDPATH**/ ?>