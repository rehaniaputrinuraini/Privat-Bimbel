            ...
            <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 13px; white-space: nowrap;">
                ...
                <tbody id="tableBody" style="color: #374151;">
                    ...
                    <tr style="border-bottom: 1px solid #F3F4F6; transition: 0.2s;" onmouseover="this.style.background='#F9FAFB'" onmouseout="this.style.background='transparent'">
                        ...
                        <td style="padding: 15px; font-weight: 500;">TE<?php echo e(str_pad($t->id_pegawai, 4, '0', STR_PAD_LEFT)); ?></td>
                        <td style="padding: 15px;"><?php echo e($t->nama_lengkap ?? '-'); ?></td>
                        <td style="padding: 15px;"><?php echo e($t->alamat ?? '-'); ?></td>
                        ...
                        <td style="padding: 15px; text-align: right;">Rp <?php echo e(number_format($t->hr_sd ?? 0, 0, ',', '.')); ?></td>
                        <td style="padding: 15px; text-align: right;">Rp <?php echo e(number_format($t->hr_smp ?? 0, 0, ',', '.')); ?></td>
                        <td style="padding: 15px; text-align: right;">Rp <?php echo e(number_format($t->hr_sma ?? 0, 0, ',', '.')); ?></td>
                        <td style="padding: 15px; text-align: right;">Rp <?php echo e(number_format($t->uang_makan ?? 0, 0, ',', '.')); ?></td>
                        <td style="padding: 15px; text-align: right;">Rp <?php echo e(number_format($t->uang_transport ?? 0, 0, ',', '.')); ?></td>
                    </tr>
