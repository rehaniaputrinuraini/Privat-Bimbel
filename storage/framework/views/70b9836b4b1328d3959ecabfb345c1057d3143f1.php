...
<div style="width: 100%;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px; gap: 15px;">
        ...
        <a href="<?php echo e(route('superadmin.kelola-admin.create')); ?>" style="text-decoration: none;">
                    ...
                    <tr style="border-bottom: 1px solid #F3F4F6; transition: 0.2s;" onmouseover="this.style.background='#F9FAFB'" onmouseout="this.style.background='transparent'">
                        ...
                        <td style="padding: 15px;">
                            <div style="display: flex; gap: 8px; justify-content: center;">
                                <a href="<?php echo e(route('superadmin.kelola-admin.edit', $item->id_user)); ?>" 
...
<script>
    ...
    function bukaModalHapus(id, nama) {
        ...
        let url = "<?php echo e(route('superadmin.kelola-admin.destroy', ':id')); ?>";
