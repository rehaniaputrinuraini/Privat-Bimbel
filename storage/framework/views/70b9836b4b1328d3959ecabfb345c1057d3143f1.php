            ...
            <tbody id="tableBody" style="color: #374151;">
                ...
                <tr style="border-bottom: 1px solid #F3F4F6; transition: 0.2s;" onmouseover="this.style.background='#F9FAFB'" onmouseout="this.style.background='transparent'">
                    ...
                    <div style="display: flex; gap: 4px; justify-content: center; flex-wrap: nowrap;">
                        <button onclick="bukaModalEdit('<?php echo e($hashId); ?>')" 
                        ...
                        <button onclick="bukaModalPassword('<?php echo e($hashId); ?>', '<?php echo e($item->pegawai->nama_lengkap ?? $item->username); ?>')" 
                        ...
                        <button type="button" onclick="bukaModalHapus('<?php echo e($hashId); ?>', '<?php echo e($item->pegawai->nama_lengkap ?? $item->username); ?>')" 
                        ...
                        <button type="button" onclick="bukaModalToggle('<?php echo e($hashId); ?>', '<?php echo e($item->pegawai->nama_lengkap ?? $item->username); ?>', '<?php echo e($item->status); ?>')" 
...
<script>
    ...
    function bukaModalEdit(hashId) {
        fetch("<?php echo e(route('superadmin.kelola-admin.edit', '')); ?>/" + hashId)
            .then(r => r.text())
            .then(html => {
                document.getElementById('modalContent').innerHTML = html;
                document.getElementById('modalForm').style.display = 'flex';
...
function bukaModalPassword(hashId, nama) {
    ...
    setTimeout(() => {
        ...
        document.getElementById('formPassword').addEventListener('submit', function(e) {
            ...
            fetch("<?php echo e(route('superadmin.kelola-admin.updatePassword', '')); ?>/" + hashId, {
                method: 'PUT',
                headers: {
    ...
    function bukaModalToggle(hashId, nama, status) {
        document.getElementById('formToggle').action = "<?php echo e(route('superadmin.kelola-admin.toggleStatus', '')); ?>/" + hashId;
    ...
    function bukaModalHapus(hashId, nama) {
        document.getElementById('formHapus').action = "<?php echo e(route('superadmin.kelola-admin.destroy', '')); ?>/" + hashId;
