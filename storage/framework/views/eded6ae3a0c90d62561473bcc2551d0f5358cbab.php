...
<div style="width: 100%;">
            ...
            <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 13px; white-space: nowrap;">
                ...
                <tbody id="tableBody" style="color: #374151;">
                    ...
                    <tr id="<?php echo e($rowId); ?>" style="border-bottom: 1px solid #F3F4F6;">
                        ...
                        <td style="padding: 15px; max-width: 80px; overflow: hidden; text-overflow: ellipsis;" title="<?php echo e($t->alamat); ?>"><?php echo e($t->alamat ?? '-'); ?></td>
                        ...
                        <td style="padding: 15px; text-align: center;">
                            <button onclick="toggleDetail('<?php echo e($rowId); ?>', '<?php echo e($hashId); ?>')" 
                        ...
                        <td style="padding: 15px; white-space: nowrap;">
                            <div style="display: flex; gap: 3px; justify-content: center; flex-wrap: nowrap;">
                                <button onclick="bukaModalEdit('<?php echo e($hashId); ?>')" style="background: #5EB37E; color: white; padding: 4px 7px; border-radius: 5px; border: none; cursor: pointer; font-size: 10px; white-space: nowrap;"><i class="far fa-edit"></i> Edit</button>
                                <button onclick="bukaModalPassword('<?php echo e($hashId); ?>', '<?php echo e($nama); ?>')" style="background: #F59E0B; color: white; padding: 4px 7px; border-radius: 5px; border: none; cursor: pointer; font-size: 10px; white-space: nowrap;"><i class="fas fa-key"></i> Pass</button>
                                <button onclick="bukaModalHapus('<?php echo e($hashId); ?>', '<?php echo e($nama); ?>')" style="background: #E35D5D; color: white; padding: 4px 7px; border-radius: 5px; border: none; cursor: pointer; font-size: 10px; white-space: nowrap;"><i class="fas fa-trash"></i> Hapus</button>
                                <button onclick="bukaModalToggle('<?php echo e($hashId); ?>', '<?php echo e($nama); ?>', '<?php echo e($status); ?>')" style="background: <?php echo e($status == 1 ? '#EF4444' : '#10B981'); ?>; color: white; padding: 4px 7px; border-radius: 5px; border: none; cursor: pointer; font-size: 10px; white-space: nowrap;"><i class="fas <?php echo e($status == 1 ? 'fa-ban' : 'fa-check'); ?>"></i> <?php echo e($status == 1 ? 'Nonaktif' : 'Aktifkan'); ?></button>
                            </div>
                        </td>
                    </tr>
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 20px; padding: 0 5px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <span style="color: #374151; font-size: 13px;">Menampilkan <?php echo e($tentors->total() ?? 0); ?> data</span>
        </div>
        <div style="display: flex; gap: 5px;">
            ...
            <?php else: ?>
                <a href="<?php echo e($tentors->url(1)); ?>&per_page=<?php echo e(request('per_page', 10)); ?>" style="width: 35px; height: 35px; border-radius: 8px; border: 1px solid #E5E7EB; background: white; color: #374151; display: flex; align-items: center; justify-content: center; text-decoration: none;"><i class="fas fa-angle-double-left"></i></a>
                <a href="<?php echo e($tentors->previousPageUrl()); ?>&per_page=<?php echo e(request('per_page', 10)); ?>" style="width: 35px; height: 35px; border-radius: 8px; border: 1px solid #E5E7EB; background: white; color: #374151; display: flex; align-items: center; justify-content: center; text-decoration: none;"><i class="fas fa-angle-left"></i></a>
            <?php endif; ?>

            <?php $start = max(1, $tentors->currentPage() - 2); $end = min($tentors->lastPage(), $tentors->currentPage() + 2); ?>
            <?php for($i = $start; $i <= $end; $i++): ?>
                <?php if($i == $tentors->currentPage()): ?>
                ...
                <?php else: ?>
                    <a href="<?php echo e($tentors->url($i)); ?>&per_page=<?php echo e(request('per_page', 10)); ?>" style="width: 35px; height: 35px; border-radius: 8px; border: 1px solid #E5E7EB; background: white; color: #374151; display: flex; align-items: center; justify-content: center; text-decoration: none;"><?php echo e($i); ?></a>
                <?php endif; ?>
            <?php endfor; ?>

            <?php if($tentors->hasMorePages()): ?>
                <a href="<?php echo e($tentors->nextPageUrl()); ?>&per_page=<?php echo e(request('per_page', 10)); ?>" style="width: 35px; height: 35px; border-radius: 8px; border: 1px solid #E5E7EB; background: white; color: #374151; display: flex; align-items: center; justify-content: center; text-decoration: none;"><i class="fas fa-angle-right"></i></a>
            <?php else: ?>
...
<script>
    ...
    function toggleDetail(rowId, hashId) {
        ...
        if (existingDetail) {
            ...
            fetch("<?php echo e(route('superadmin.kelola-tentor.detail', '')); ?>/" + hashId)
                .then(r => r.json())
                .then(data => {
    ...
    function bukaModalEdit(hashId) {
        fetch("<?php echo e(route('superadmin.kelola-tentor.edit', '')); ?>/" + hashId)
            .then(r => r.text())
            .then(html => {
                document.getElementById('modalContent').innerHTML = html;
                document.getElementById('modalForm').style.display = 'flex';
    ...
    function bukaModalPassword(hashId, nama) {
        ...
        <div style="padding:20px;font-family:'Poppins',sans-serif;background:#FFF;border-radius:16px">
            ...
            <div id="alertErrorPass" style="display:none;background:#FEE2E2;color:#991B1B;padding:12px 15px;border-radius:10px;margin-bottom:15px;">
            ...
            <form id="formPassword">
                <div style="margin-bottom:15px">
                    ...
                    <div style="position: relative; width: 100%;">
                        <input type="password" id="pass1" required placeholder="Masukkan password baru" style="width:100%;padding:12px 45px 12px 15px;border-radius:12px;border:1.5px solid #E5E7EB;outline:none;font-size:14px;font-family:'Poppins',sans-serif;box-sizing:border-box">
                        <button type="button"
                                onclick="
                ...
                <div style="margin-bottom:15px">
                    ...
                    <div style="position: relative; width: 100%;">
                        <input type="password" id="pass2" required placeholder="Konfirmasi password baru" style="width:100%;padding:12px 45px 12px 15px;border-radius:12px;border:1.5px solid #E5E7EB;outline:none;font-size:14px;font-family:'Poppins',sans-serif;box-sizing:border-box">
                        <button type="button"
                                onclick="
                ...
                <div style="display:flex;justify-content:flex-end;gap:20px;margin-top:30px;padding-top:16px;border-top:1.5px solid #F3F4F6">
                    ...
                    <button type="submit" id="btnSimpanPass" style="padding:10px 45px;border:none;background:#4D0B87;color:#fff;border-radius:10px;font-weight:600;font-size:16px;cursor:pointer;">Simpan</button>
                </div>
            </form>
        </div>
        <div id="modalSuksesPass" style="display:none;position:fixed;z-index:99999;left:0;top:0;width:100%;height:100%;background:rgba(0,0,0,0.4);backdrop-filter:blur(3px);align-items:center;justify-content:center">
            <div style="background:#fff;padding:25px;border-radius:20px;width:320px;text-align:center;">
                ...
                <button id="btnOkPass" style="width:100%;padding:10px;border-radius:10px;border:none;background:#10B981;color:#fff;font-weight:600;cursor:pointer">OK</button>
            </div>
        </div>`;
        ...
        setTimeout(() => {
            ...
            document.getElementById('formPassword').addEventListener('submit', function(e) {
                ...
                // 🔥 PERBAIKAN: pakai hashId, bukan id polos
                fetch("<?php echo e(route('superadmin.kelola-tentor.updatePassword', '')); ?>/" + hashId, { 
                    method: 'PUT', 
                    headers: { 
                ...
                .then(r => r.json()).then(data => { 
                    if (data.success) { 
                        document.getElementById('modalSuksesPass').style.display = 'flex'; 
                    } else { 
                ...
                .catch(() => { 
                    eTxt.textContent = 'Error koneksi'; 
                    eDiv.style.display = 'flex'; 
                    btn.disabled = false; 
                    btn.innerHTML = 'Simpan'; 
                });
    ...
    function bukaModalToggle(hashId, nama, status) {
        document.getElementById('formToggle').action = "<?php echo e(route('superadmin.kelola-tentor.toggleStatus', '')); ?>/" + hashId;
        if (status == 1) {
    ...
    function bukaModalHapus(hashId, nama) {
        document.getElementById('formHapus').action = "<?php echo e(route('superadmin.kelola-tentor.destroy', '')); ?>/" + hashId;
