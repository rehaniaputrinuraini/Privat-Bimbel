                    ...
                    <tr style="border-bottom: 1px solid #F3F4F6; transition: 0.2s;" onmouseover="this.style.background='#F9FAFB'" onmouseout="this.style.background='transparent'">
                        ...
                        <td style="padding: 15px; text-align: center;">
                            <div style="display: flex; gap: 8px; justify-content: center;">
                                ...
                                <button type="button" onclick="bukaModalHapus('<?php echo e($hashId); ?>', 'PK<?php echo e(str_pad($item->id_paket, 4, '0', STR_PAD_LEFT)); ?> - <?php echo e($item->tingkat); ?>')" 
...
<script>
    ...
    function bukaModalEdit(hashId) {
        fetch("<?php echo e(route($role . '.master-data.harga-paket.edit', '')); ?>/" + hashId)
            .then(r => r.text())
            .then(html => {
                document.getElementById('modalContent').innerHTML = html;
                document.getElementById('modalForm').style.display = 'flex';
    ...
    function bukaModalHapus(hashId, nama) {
        document.getElementById('formHapus').action = "<?php echo e(route($role . '.master-data.harga-paket.destroy', '')); ?>/" + hashId;
