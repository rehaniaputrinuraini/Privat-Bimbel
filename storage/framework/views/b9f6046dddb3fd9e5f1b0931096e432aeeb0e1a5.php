    ...
    <div style="background: white; border-radius: 20px; padding: 25px; box-shadow: 0 4px 15px rgba(0,0,0,0.08);">
        ...
        <?php if(session('success_paket')): ?>
            <div style="background: #D1FAE5; color: #065F46; padding: 12px; border-radius: 10px; margin-bottom: 20px;">
                <?php echo e(session('success_paket')); ?>
        ...
        <table style="width: 100%; border-collapse: collapse;">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $paket; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr style="border-bottom: 1px solid #F3F4F6;">
                    ...
                    <td style="padding: 15px; text-align: center;">
                        <a href="<?php echo e(route($role . '.harga-paket.edit', $item->id_paket)); ?>" style="background: #5EB37E; color: white; padding: 6px 12px; border-radius: 6px; text-decoration: none;">Edit</a>
                        <form action="<?php echo e(route($role . '.harga-paket.destroy', $item->id_paket)); ?>" method="POST" style="display: inline;">
