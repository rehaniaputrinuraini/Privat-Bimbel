    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px; gap: 15px;">
        <div style="display: flex; align-items: center; gap: 12px; flex: 1;">
            <div style="position: relative; width: 300px;">
                ...
                <input type="text" id="searchInput" placeholder="Cari Tingkat atau Harga..." 
        ...
        <a href="<?php echo e(route($role . '.master-data.harga-paket.create')); ?>" style="text-decoration: none;">
            ...
            <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 13px;">
                <thead>
                    <tr style="background: #F3E8FF; color: #111827;">
                        ...
                        <th style="padding: 15px; font-weight: 700; text-align: center;">Tingkat</th>
                        <th style="padding: 15px; font-weight: 700; text-align: center;">Harga</th>
                    ...
                    <tr style="border-bottom: 1px solid #F3F4F6; transition: 0.2s;" onmouseover="this.style.background='#F9FAFB'" onmouseout="this.style.background='transparent'">
                        ...
                        <td style="padding: 15px; text-align: center;">
                            <div style="display: flex; gap: 8px; justify-content: center;">
                                <a href="<?php echo e(route($role . '.master-data.harga-paket.edit', $item->id_paket)); ?>" 
                                ...
                                <button type="button" 
                                        onclick="bukaModalHapus('<?php echo e($item->id_paket); ?>', 'PK<?php echo e(str_pad($item->id_paket, 4, '0', STR_PAD_LEFT)); ?> - <?php echo e($item->tingkat); ?>')" 
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 20px; padding: 0 5px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            <span style="color: #374151; font-size: 13px;">
                Menampilkan <?php echo e($paket->total()); ?> data
            </span>
        </div>
        <div style="display: flex; gap: 5px;">
            ...
            <?php else: ?>
                <a href="<?php echo e($paket->url(1)); ?>" style="width: 35px; height: 35px; border-radius: 8px; border: 1px solid #E5E7EB; background: white; color: #374151; display: flex; align-items: center; justify-content: center; text-decoration: none;">
                    <i class="fas fa-angle-double-left"></i>
                </a>
                <a href="<?php echo e($paket->previousPageUrl()); ?>" style="width: 35px; height: 35px; border-radius: 8px; border: 1px solid #E5E7EB; background: white; color: #374151; display: flex; align-items: center; justify-content: center; text-decoration: none;">
                    <i class="fas fa-angle-left"></i>
                </a>
            <?php endif; ?>
            ...
            <?php if($paket->hasMorePages()): ?>
                <a href="<?php echo e($paket->nextPageUrl()); ?>" style="width: 35px; height: 35px; border-radius: 8px; border: 1px solid #E5E7EB; background: white; color: #374151; display: flex; align-items: center; justify-content: center; text-decoration: none;">
...
<script>
    ...
    function bukaModalHapus(id, nama) {
        ...
        form.action = "<?php echo e(route($role . '.master-data.harga-paket.destroy', '')); ?>/" + id;
