            ...
            <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 13px;">
                ...
                <tbody id="tableBody" style="color: #374151;">
                    ...
                    <tr style="border-bottom: 1px solid #F3F4F6; transition: 0.2s;" onmouseover="this.style.background='#F9FAFB'" onmouseout="this.style.background='transparent'">
                        ...
                        <td style="padding: 15px;">PK<?php echo e(str_pad($item->id_paket, 4, '0', STR_PAD_LEFT)); ?></td>
                        <td style="padding: 15px;">Rp <?php echo e(number_format($item->harga, 0, ',', '.')); ?></td>
                        <td style="padding: 15px;"><?php echo e($item->tingkat); ?></td>
                        <td style="padding: 15px; text-align: center;">
                            <div style="display: flex; gap: 8px; justify-content: center;">
                                <a href="<?php echo e(route($role . '.harga-paket.edit', $item->id_paket)); ?>" 
                                ...
                                <button type="button" 
                                        onclick="bukaModalHapus('<?php echo e($item->id_paket); ?>', 'PK<?php echo e(str_pad($item->id_paket, 4, '0', STR_PAD_LEFT)); ?>')" 
...
<script>
    ...
    function bukaModalHapus(id, nama) {
        ...
        let url = "<?php echo e(route($role . '.harga-paket.destroy', ':id')); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Privat-Bimbel\resources\views/dashboard/shared/harga-paket/harga-paket.blade.php ENDPATH**/ ?>