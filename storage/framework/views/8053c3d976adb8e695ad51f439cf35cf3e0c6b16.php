<div style="padding: 20px; font-family: 'Poppins', sans-serif; background: #FFFFFF; border-radius: 16px;">
    ...
    <div style="margin-bottom: 20px; padding-bottom: 14px; border-bottom: 1.5px solid #F3F4F6;">
        <h2 style="font-size: 19px; font-weight: 700; color: #111827; margin: 0;">Tambah Kelas</h2>
    ...
    <form id="mainForm" action="<?php echo e(route($role . '.master-data.kelas.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        ...
        <div style="margin-bottom: 15px;">
            ...
            <input type="text" name="nama_kelas" id="nama_kelas" value="<?php echo e(old('nama_kelas')); ?>" placeholder="Masukkan nama kelas" required
...
</div><?php /**PATH C:\xampp\htdocs\Privat-Bimbel\resources\views/dashboard/shared/master-data/kelas/create.blade.php ENDPATH**/ ?>