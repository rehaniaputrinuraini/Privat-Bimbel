...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="margin-bottom: 15px;">
                ...
                <textarea name="alamat_admin" rows="2" placeholder="Masukkan Alamat" required
                          style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #FFFFFF; outline: none; font-family: 'Poppins', sans-serif; font-size: 14px; resize: vertical;"><?php echo e(old('alamat_admin', $admin->admin->alamat_admin ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0 40px; margin-bottom: 15px;">
                <div>
                    ...
                    <input type="tel" inputmode="numeric" name="no_hp_admin" value="<?php echo e(old('no_hp_admin', $admin->admin->no_hp_admin ?? '')); ?>" placeholder="Masukkan No HP" required
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0 40px; margin-bottom: 15px;">
                <div>
                    ...
                    <input type="text" inputmode="numeric" name="gaji_pokok" value="<?php echo e(old('gaji_pokok', $admin->admin->gaji_pokok ?? 0)); ?>" placeholder="Masukkan Gaji Pokok" required
                           onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                           oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                           style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #FFFFFF; outline: none; font-size: 14px;">
