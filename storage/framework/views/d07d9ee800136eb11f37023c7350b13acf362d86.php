<div style="padding: 20px; font-family: 'Poppins', sans-serif; background: #FFFFFF; border-radius: 16px;">
    ...
    <form id="mainForm" action="<?php echo e(route('superadmin.kelola-admin.update', $admin->id_user)); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\xampp\htdocs\Privat-Bimbel\resources\views/dashboard/superadmin/kelola-admin/edit-admin.blade.php ENDPATH**/ ?>