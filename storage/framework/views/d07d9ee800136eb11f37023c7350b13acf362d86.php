    ...
    <div style="background: #F9FAFB; border-radius: 15px; padding: 30px; border: 1.5px solid #E5E7EB; box-shadow: 0 4px 10px rgba(0,0,0,0.02);" data-aos="fade-up">
        ...
        <form action="<?php echo e(route('superadmin.kelola-admin.update', $admin->id_user)); ?>" method="POST" id="mainForm">
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input type="text" name="nama_lengkap" value="<?php echo e(old('nama_lengkap', $admin->pegawai->nama_lengkap ?? '')); ?>" placeholder="Masukkan Nama Lengkap" required
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="margin-bottom: 15px;">
                ...
                <textarea name="alamat" rows="2" placeholder="Masukkan Alamat" required
                          style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #FFFFFF; outline: none; font-family: 'Poppins', sans-serif; font-size: 14px; resize: vertical;"><?php echo e(old('alamat', $admin->pegawai->alamat ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0 40px; margin-bottom: 15px;">
                <div>
                    ...
                    <input type="tel" inputmode="numeric" name="no_hp" value="<?php echo e(old('no_hp', $admin->pegawai->no_hp ?? '')); ?>" placeholder="Masukkan No HP" required
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0 40px; margin-bottom: 15px;">
                <div>
                    ...
                    <input type="text" inputmode="numeric" name="gaji_pokok" value="<?php echo e(old('gaji_pokok', $admin->pegawai->gaji_pokok ?? 0)); ?>" placeholder="Masukkan Gaji Pokok" required
                           onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                           oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                           style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #FFFFFF; outline: none; font-size: 14px;">
