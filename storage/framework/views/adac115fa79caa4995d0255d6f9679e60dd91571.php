...
<body>
    ...
    <table class="data-table">
        ...
        <tr class="r-section">
            ...
            <td class="c-tot"><strong><?php echo e(number_format($saldoAwal, 0, ',', '.')); ?></strong></td>
        </tr>
        ...
        <tr class="r-item">
            ...
            <td class="c-nom"><?php echo e(number_format($pemasukanData['Pendaftaran'], 0, ',', '.')); ?></td>
        ...
        <tr class="r-item">
            ...
            <td class="c-rp-item">Rp.</td>
            <td class="c-nom"><?php echo e(number_format($pemasukanData['Bimbingan'], 0, ',', '.')); ?></td>
            <td class="c-rp-tot"></td>
            <td class="c-tot"></td>
        </tr>
        <tr class="r-item">
            ...
            <td class="c-rp-item">Rp.</td>
            <td class="c-nom"><?php echo e(number_format($pemasukanData['Modal_Owner'], 0, ',', '.')); ?></td>
            <td class="c-rp-tot"></td>
            <td class="c-tot"></td>
        </tr>
        <tr class="r-item">
            ...
            <td class="c-rp-item">Rp.</td>
            <td class="c-nom"><?php echo e(number_format($pemasukanData['TryOut'], 0, ',', '.')); ?></td>
            <td class="c-rp-tot"></td>
            <td class="c-tot"></td>
        </tr>
        <tr class="r-item">
            ...
            <td class="c-rp-item">Rp.</td>
            <td class="c-nom"><?php echo e(number_format($pemasukanData['Lainnya_Pemasukan'], 0, ',', '.')); ?></td>
            <td class="c-rp-tot"></td>
            <td class="c-tot"></td>
        </tr>
        <tr class="r-total">
            ...
            <td class="c-nom"></td>
            <td class="c-rp-tot"><strong>Rp.</strong></td>
            <td class="c-tot"><strong><?php echo e(number_format($totalPemasukan, 0, ',', '.')); ?></strong></td>
        </tr>
        ...
        <tr class="r-item">
            ...
            <td class="c-rp-item">Rp.</td>
            <td class="c-nom"><?php echo e(number_format($pengeluaranData['BiayaOperasional'], 0, ',', '.')); ?></td>
            <td class="c-rp-tot"></td>
            <td class="c-tot"></td>
        </tr>
        <tr class="r-item">
            ...
            <td class="c-rp-item">Rp.</td>
            <td class="c-nom"><?php echo e(number_format($pengeluaranData['BiayaRapatPelatihan'], 0, ',', '.')); ?></td>
            <td class="c-rp-tot"></td>
            <td class="c-tot"></td>
        </tr>
        <tr class="r-item">
            ...
            <td class="c-rp-item">Rp.</td>
            <td class="c-nom"><?php echo e(number_format($pengeluaranData['FeeManagement'], 0, ',', '.')); ?></td>
            <td class="c-rp-tot"></td>
            <td class="c-tot"></td>
        </tr>
        <tr class="r-item">
            ...
            <td class="c-rp-item">Rp.</td>
            <td class="c-nom"><?php echo e(number_format($pengeluaranData['PembelianAktiva'], 0, ',', '.')); ?></td>
            <td class="c-rp-tot"></td>
            <td class="c-tot"></td>
        </tr>
        <tr class="r-item">
            ...
            <td class="c-rp-item">Rp.</td>
            <td class="c-nom"><?php echo e(number_format($pengeluaranData['Modul'], 0, ',', '.')); ?></td>
            <td class="c-rp-tot"></td>
            <td class="c-tot"></td>
        </tr>
        <tr class="r-item">
            ...
            <td class="c-rp-item">Rp.</td>
            <td class="c-nom"><?php echo e(number_format($pengeluaranData['BiayaAkademik'], 0, ',', '.')); ?></td>
            <td class="c-rp-tot"></td>
            <td class="c-tot"></td>
        </tr>
        <tr class="r-item">
            ...
            <td class="c-rp-item">Rp.</td>
            <td class="c-nom"><?php echo e(number_format($pengeluaranData['BiayaPemasaran'], 0, ',', '.')); ?></td>
            <td class="c-rp-tot"></td>
            <td class="c-tot"></td>
        </tr>
        <tr class="r-item">
            ...
            <td class="c-rp-item">Rp.</td>
            <td class="c-nom"><?php echo e(number_format($pengeluaranData['BiayaKeuangan'], 0, ',', '.')); ?></td>
            <td class="c-rp-tot"></td>
            <td class="c-tot"></td>
        </tr>
        <tr class="r-item">
            ...
            <td class="c-rp-item">Rp.</td>
            <td class="c-nom"><?php echo e(number_format($pengeluaranData['SetorKePusat'], 0, ',', '.')); ?></td>
            <td class="c-rp-tot"></td>
            <td class="c-tot"></td>
        </tr>
        <tr class="r-item">
        ...
        <tr class="r-total">
            ...
            <td class="c-nom"></td>
            <td class="c-rp-tot"><strong>Rp.</strong></td>
            <td class="c-tot"><strong><?php echo e(number_format($totalPengeluaran, 0, ',', '.')); ?></strong></td>
        </tr>
        ...
        <tr class="r-saldo">
            ...
            <td class="c-nom"></td>
            <td class="c-rp-tot"><strong>Rp.</strong></td>
            <td class="c-tot"><strong><?php echo e(number_format($saldoAkhir, 0, ',', '.')); ?></strong></td>
        </tr>
