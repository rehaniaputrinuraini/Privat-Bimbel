...
<div style="width: 100%;">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px; gap: 15px;">
            <div style="display: flex; align-items: center; gap: 12px; flex: 1; flex-wrap: wrap;">
                ...
                <div style="position: relative; width: 300px;">
                    ...
                    <input type="text" name="search" value="<?php echo e(request('search', $search ?? '')); ?>" placeholder="Cari Nama Tentor, Kelas..."
                ...
                <?php if(request('search') || request('bulan') || request('tahun')): ?>
                ...
                <tbody id="tableBody" style="color: #374151;">
                    ...
                    <tr style="border-bottom: 1px solid #F3F4F6; transition: 0.2s;" onmouseover="this.style.background='#F9FAFB'" onmouseout="this.style.background='transparent'">
                        ...
                        <td style="padding: 15px; font-weight: 500;">
                            ...
                            <?php if($isSesiPertama): ?><br><span class="badge-sesi-pertama">Sesi 1</span><?php endif; ?>
                        </td>
                        ...
                        <td style="padding: 15px; text-align: center;"><span class="<?php echo e($statusClass); ?>"><?php echo e($statusText); ?></span></td>
                        <td style="padding: 15px; text-align: right;">Rp <?php echo e(number_format($honorDasar, 0, ',', '.')); ?></td>
                        <td style="padding: 15px; text-align: center;">
                            <?php if(!$isHadir): ?><span style="color: #EF4444; font-size: 11px;">-50%</span><br><span style="color: #EF4444; font-size: 11px;">(Rp <?php echo e(number_format($potongan, 0, ',', '.')); ?>)</span><?php else: ?><span style="color: #10B981;">-</span><?php endif; ?>
                        </td>
                        <td style="padding: 15px; text-align: right; font-weight: 600; color: #4D0B87;">Rp <?php echo e(number_format($honorAkhir, 0, ',', '.')); ?></td>
                        <td style="padding: 15px; text-align: right;"><?php if($isSesiPertama): ?> Rp <?php echo e(number_format($uangMakan, 0, ',', '.')); ?><?php else: ?><span style="color: #9CA3AF;">-</span><?php endif; ?></td>
                        <td style="padding: 15px; text-align: right;"><?php if($isSesiPertama): ?> Rp <?php echo e(number_format($transport, 0, ',', '.')); ?><?php else: ?><span style="color: #9CA3AF;">-</span><?php endif; ?></td>
                        <td style="padding: 15px; text-align: right; font-weight: 700; color: #111827;">Rp <?php echo e(number_format($totalHonorItem, 0, ',', '.')); ?></td>
                        <td style="padding: 15px; text-align: left; white-space: normal; word-break: break-word; max-width: 200px;" title="<?php echo e($item->keterangan ?? ''); ?>"><?php echo e($item->keterangan ?: '-'); ?></td>
                        <td style="padding: 15px; text-align: center;">
                        ...
                        <td style="padding: 15px; text-align: center;">
                            <?php if($role == 'superadmin' || $role == 'admin'): ?>
                                <?php if($isVerified): ?>
                                    <form method="POST" action="<?php echo e(route($role . '.kelola-presensi.unverify', ['hashId' => hash_id($item->id_mengajar)])); ?>" style="display: inline;">
                                        <?php echo csrf_field(); ?>
                                ...
                                <?php else: ?>
                                    <form method="POST" action="<?php echo e(route($role . '.kelola-presensi.verify', ['hashId' => hash_id($item->id_mengajar)])); ?>" style="display: inline;">
                                        <?php echo csrf_field(); ?>
                                ...
                                <?php endif; ?>
                            <?php else: ?>
                                <?php if($isVerified): ?><span class="badge-verified">✅ Verified</span><?php else: ?><span style="color: #9CA3AF; font-size: 13px;">⏳ Pending</span><?php endif; ?>
                            <?php endif; ?>
                        </td>
                        <?php if($role == 'superadmin'): ?>
                        <td style="padding: 15px; text-align: center;">
                            <button type="button" 
                                    onclick="bukaModalHapus('<?php echo e(hash_id($item->id_mengajar)); ?>', '<?php echo e(addslashes($namaTentor)); ?>', '<?php echo e(\Carbon\Carbon::parse($item->tanggal)->format('d F Y')); ?>')" 
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 20px; padding: 0 5px; margin-bottom: 40px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <span style="color: #374151; font-size: 13px;">Menampilkan <?php echo e($presensi->total() ?? 0); ?> data</span>
        </div>
        <div style="display: flex; gap: 5px;">
            ...
            <?php else: ?>
                <a href="<?php echo e($presensi->url(1)); ?>" style="width:35px;height:35px;border-radius:8px;border:1px solid #E5E7EB;background:white;color:#374151;display:flex;align-items:center;justify-content:center;text-decoration:none;">
                    <i class="fas fa-angle-double-left"></i>
                </a>
                <a href="<?php echo e($presensi->previousPageUrl()); ?>" style="width:35px;height:35px;border-radius:8px;border:1px solid #E5E7EB;background:white;color:#374151;display:flex;align-items:center;justify-content:center;text-decoration:none;">
                    <i class="fas fa-angle-left"></i>
                </a>
            <?php endif; ?>

            <?php $start = max(1, $presensi->currentPage() - 2); $end = min($presensi->lastPage(), $presensi->currentPage() + 2); ?>
            <?php for($i = $start; $i <= $end; $i++): ?>
                <?php if($i == $presensi->currentPage()): ?>
                ...
                <?php else: ?>
                    <a href="<?php echo e($presensi->url($i)); ?>" style="width:35px;height:35px;border-radius:8px;border:1px solid #E5E7EB;background:white;color:#374151;display:flex;align-items:center;justify-content:center;text-decoration:none;">
                        <?php echo e($i); ?>
            ...
            <?php if($presensi->hasMorePages()): ?>
                <a href="<?php echo e($presensi->nextPageUrl()); ?>" style="width:35px;height:35px;border-radius:8px;border:1px solid #E5E7EB;background:white;color:#374151;display:flex;align-items:center;justify-content:center;text-decoration:none;">
