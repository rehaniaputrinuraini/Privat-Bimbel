...
<?php $__env->startSection('title', 'Transaksi Pemasukan'); ?>
            ...
            <tbody id="tagihanTableBody">
                ...
                <tr style="border-bottom: 1px solid #F3F4F6;">
                    ...
                    <td style="padding: 15px; text-align: center;">
                        ...
                        <?php elseif($t->status_tagihan == 'Belum Daftar'): ?>
                    ...
                    <td style="padding: 15px; text-align: center; color: #6B7280;"><?php echo e($t->tagihan_bulan ?? '-'); ?></td>
                    <td style="padding: 15px; text-align: center; <?php echo e($t->total_piutang != '-' ? 'font-weight:700;color:#EF4444;' : ''); ?>">
                        <?php echo e($t->total_piutang ?? '-'); ?>

                    </td>
                    <td style="padding: 15px; text-align: center; <?php echo e($t->uang_muka != '-' ? 'font-weight:600;color:#4338CA;' : ''); ?>">
                        <?php echo e($t->uang_muka ?? '-'); ?>
