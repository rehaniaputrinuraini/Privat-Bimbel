...
<div style="padding: 10px; font-family: 'Poppins', sans-serif;">
    ...
    <div style="background: #F9FAFB; border-radius: 15px; padding: 30px; border: 1.5px solid #E5E7EB; box-shadow: 0 4px 10px rgba(0,0,0,0.02);">
        <form action="<?php echo e(route('superadmin.kelas.update', $kelas->id_kelas)); ?>" method="POST" id="mainForm">
            <?php echo csrf_field(); ?>
            ...
            <div style="margin-bottom: 15px;">
                ...
                <select name="id_periode" required 
                    ...
                    <?php $__currentLoopData = $periodeList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $periode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($periode->id_periode); ?>" <?php echo e(old('id_periode', $kelas->id_periode) == $periode->id_periode ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input type="text" value="<?php echo e($kelas->jumlah_murid ?? 0); ?>" readonly 
                       style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #F3F4F6; outline: none; color: #6B7280; font-size: 14px;">
                <small style="color: #9CA3AF;"><i class="fas fa-info-circle"></i> Jumlah murid dihitung otomatis.</small>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Privat-Bimbel\resources\views/dashboard/shared/master-data/kelas/edit.blade.php ENDPATH**/ ?>