<div style="padding: 20px; font-family: 'Poppins', sans-serif; background: #FFFFFF; border-radius: 16px;">
    ...
    <form id="mainForm" action="<?php echo e(route($role . '.master-data.kelas.update', $kelas->id_kelas)); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>
        <input type="hidden" name="id_periode" value="<?php echo e($periodeAktif->id_periode ?? $kelas->id_periode ?? ''); ?>">
        ...
        <div style="margin-bottom: 15px;">
            ...
            <input type="text" name="nama_kelas" id="nama_kelas" value="<?php echo e(old('nama_kelas', $kelas->nama_kelas)); ?>" required
