            ...
            <tbody id="tableBody">
                ...
                <tr style="border-bottom: 1px solid #F3F4F6;">
                    ...
                    <td style="padding: 15px; text-align: center;">
                        <?php echo e($item->jumlah_sesi); ?> Sesi (<?php echo e($item->hari_unik); ?> Hari)
                    </td>
                    ...
                    <td style="padding: 15px; text-align: right;">
                        ...
                        <br><small style="color:#9CA3AF;">(Rp <?php echo e(number_format($item->uang_makan_per_hari, 0, ',', '.')); ?> × <?php echo e($item->hari_unik); ?> hari)</small>
                    </td>
                    
                    <td style="padding: 15px; text-align: right;">
                        Rp <?php echo e(number_format($item->uang_transport, 0, ',', '.')); ?>

                        <br><small style="color:#9CA3AF;">(Rp <?php echo e(number_format($item->uang_transport_per_hari, 0, ',', '.')); ?> × <?php echo e($item->hari_unik); ?> hari)</small>
                    </td>
                    ...
                    <td style="padding: 15px; text-align: center;">
                        <div style="display: flex; gap: 6px; justify-content: center; align-items: center;">
                            <button onclick="bukaDetailPenggajian('<?php echo e(hash_id($item->id_pegawai)); ?>')"
                            ...
                            <?php if(!$item->sudah_dibayar): ?>
                                <button type="button" onclick="klikBayar('<?php echo e(hash_id($item->id_pegawai)); ?>', '<?php echo e($item->nama); ?>', <?php echo e($item->total_gaji); ?>, <?php echo e($item->jumlah_sesi); ?>)" 
...
<script>
    ...
    function bukaDetailPenggajian(hashId) {
        const bulan = document.getElementById('filterBulan').value;
        const tahun = document.getElementById('filterTahun').value;
        const url = "<?php echo e(url($role . '/penggajian/detail')); ?>/" + hashId + "?bulan=" + bulan + "&tahun=" + tahun;
