...
<?php $__env->startSection('title', 'Transaksi Penggajian'); ?>
...
<div style="width: 100%;">
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 13px; white-space: nowrap; font-family: 'Poppins', sans-serif;">
            ...
            <tbody id="tableBody">
                ...
                <tr style="border-bottom: 1px solid #F3F4F6;">
                    ...
                    <td style="padding: 15px; text-align: center;"><?php echo e($item->jumlah_sesi); ?></td>
                    <td style="padding: 15px; text-align: right;">Rp <?php echo e(number_format($item->honor_per_sesi, 0, ',', '.')); ?></td>
                    <td style="padding: 15px; text-align: right;">Rp <?php echo e(number_format($item->total_honor, 0, ',', '.')); ?></td>
                    <td style="padding: 15px; text-align: right;">Rp <?php echo e(number_format($item->uang_makan, 0, ',', '.')); ?></td>
                    <td style="padding: 15px; text-align: right;">Rp <?php echo e(number_format($item->uang_transport, 0, ',', '.')); ?></td>
                    ...
                    <td style="padding: 15px; text-align: center;">
                        <?php if(!$item->sudah_dibayar): ?>
                            <button onclick="bayarGaji('<?php echo e($item->id_pegawai); ?>', '<?php echo e($item->nama); ?>', <?php echo e($item->total_gaji); ?>, <?php echo e($item->jumlah_sesi); ?>)"
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 20px; padding: 0 5px; margin-bottom: 40px;">
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <span style="color: #374151; font-size: 13px;">Menampilkan <?php echo e($penggajian->firstItem() ?? 0); ?> - <?php echo e($penggajian->lastItem() ?? 0); ?> dari <?php echo e($penggajian->total() ?? 0); ?> data</span>
        </div>
        <div style="display: flex; gap: 5px;">
            ...
            <?php else: ?>
                <a href="<?php echo e($penggajian->url(1)); ?>&per_page=<?php echo e(request('per_page', 10)); ?>&bulan=<?php echo e($bulan); ?>&tahun=<?php echo e($tahun); ?>" style="width:35px;height:35px;border-radius:8px;border:1px solid #E5E7EB;background:white;color:#374151;display:flex;align-items:center;justify-content:center;text-decoration:none;"><i class="fas fa-angle-double-left"></i></a>
                <a href="<?php echo e($penggajian->previousPageUrl()); ?>&per_page=<?php echo e(request('per_page', 10)); ?>&bulan=<?php echo e($bulan); ?>&tahun=<?php echo e($tahun); ?>" style="width:35px;height:35px;border-radius:8px;border:1px solid #E5E7EB;background:white;color:#374151;display:flex;align-items:center;justify-content:center;text-decoration:none;"><i class="fas fa-angle-left"></i></a>
            <?php endif; ?>
            ...
            <?php for($i = $start; $i <= $end; $i++): ?>
                ...
                <?php else: ?>
                    <a href="<?php echo e($penggajian->url($i)); ?>&per_page=<?php echo e(request('per_page', 10)); ?>&bulan=<?php echo e($bulan); ?>&tahun=<?php echo e($tahun); ?>" style="width:35px;height:35px;border-radius:8px;border:1px solid #E5E7EB;background:white;color:#374151;display:flex;align-items:center;justify-content:center;text-decoration:none;"><?php echo e($i); ?></a>
                <?php endif; ?>
            <?php endfor; ?>
            <?php if($penggajian->hasMorePages()): ?>
                <a href="<?php echo e($penggajian->nextPageUrl()); ?>&per_page=<?php echo e(request('per_page', 10)); ?>&bulan=<?php echo e($bulan); ?>&tahun=<?php echo e($tahun); ?>" style="width:35px;height:35px;border-radius:8px;border:1px solid #E5E7EB;background:white;color:#374151;display:flex;align-items:center;justify-content:center;text-decoration:none;"><i class="fas fa-angle-right"></i></a>
            <?php else: ?>
...
<script>
    ...
    function konfirmasiBayar() {
        ...
        fetch(`<?php echo e(route($role . '.penggajian.bayar', '')); ?>/${bayarData.id}`, {
            method: 'POST',
            headers: {
