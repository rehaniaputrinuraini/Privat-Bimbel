...
<div style="padding: 10px; font-family: 'Poppins', sans-serif;">
    ...
    <div style="background: #F9FAFB; border-radius: 15px; padding: 30px; border: 1.5px solid #E5E7EB;">
        ...
        <form action="<?php echo e(route('superadmin.kelola-tentor.update', $tentor->id_tentor)); ?>" method="POST" id="mainForm">
            <?php echo csrf_field(); ?>
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input type="text" value="TE<?php echo e(str_pad($tentor->id_tentor, 4, '0', STR_PAD_LEFT)); ?>" readonly 
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input type="text" name="nama_lengkap_tentor" value="<?php echo e(old('nama_lengkap_tentor', $tentor->nama_lengkap_tentor)); ?>" required
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input type="text" name="alamat_tentor" value="<?php echo e(old('alamat_tentor', $tentor->alamat_tentor)); ?>"
                       style="width: 100%; padding: 12px; border-radius: 12px; border: 1px solid #E5E7EB;">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input type="text" name="no_hp_tentor" value="<?php echo e(old('no_hp_tentor', $tentor->no_hp_tentor)); ?>"
                       style="width: 100%; padding: 12px; border-radius: 12px; border: 1px solid #E5E7EB;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0 40px;">
                <div>
                    <div style="margin-bottom: 15px;">
                        ...
                        <input type="text" name="mapel" value="<?php echo e(old('mapel', $tentor->mapel)); ?>"
                               style="width: 100%; padding: 12px; border-radius: 12px; border: 1px solid #E5E7EB;">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <input type="number" name="hr_sd" value="<?php echo e(old('hr_sd', $tentor->hr_sd)); ?>"
                               style="width: 100%; padding: 12px; border-radius: 12px; border: 1px solid #E5E7EB;">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <input type="number" name="hr_smp" value="<?php echo e(old('hr_smp', $tentor->hr_smp)); ?>"
                               style="width: 100%; padding: 12px; border-radius: 12px; border: 1px solid #E5E7EB;">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <input type="number" name="hr_sma" value="<?php echo e(old('hr_sma', $tentor->hr_sma)); ?>"
                               style="width: 100%; padding: 12px; border-radius: 12px; border: 1px solid #E5E7EB;">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    <div style="margin-bottom: 15px;">
                        ...
                        <input type="number" name="uang_makan" value="<?php echo e(old('uang_makan', $tentor->uang_makan)); ?>"
                               style="width: 100%; padding: 12px; border-radius: 12px; border: 1px solid #E5E7EB;">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <input type="number" name="uang_transport" value="<?php echo e(old('uang_transport', $tentor->uang_transport)); ?>"
                               style="width: 100%; padding: 12px; border-radius: 12px; border: 1px solid #E5E7EB;">
