<div style="padding: 20px; font-family: 'Poppins', sans-serif; background: #FFFFFF; border-radius: 16px;">
    ...
    <form id="mainForm" action="<?php echo e(route('superadmin.kelola-tentor.update', $tentor->id_pegawai)); ?>" method="POST">
        <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>

        <div style="margin-bottom: 15px;"><label style="font-weight: 600; font-size: 14px; color: #374151;">Nama Lengkap <span style="color: #EF4444;">*</span></label><input type="text" name="nama_lengkap" value="<?php echo e(old('nama_lengkap', $tentor->nama_lengkap)); ?>" required style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif;"></div>
        <div style="margin-bottom: 15px;"><label style="font-weight: 600; font-size: 14px; color: #374151;">Alamat <span style="color: #EF4444;">*</span></label><textarea name="alamat" rows="2" required style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; outline: none; font-family: 'Poppins', sans-serif; font-size: 14px; resize: vertical;"><?php echo e(old('alamat', $tentor->alamat)); ?></textarea></div>
        <div style="margin-bottom: 15px;"><label style="font-weight: 600; font-size: 14px; color: #374151;">No HP <span style="color: #EF4444;">*</span></label><input type="tel" name="no_hp" value="<?php echo e(old('no_hp', $tentor->no_hp)); ?>" required oninput="this.value = this.value.replace(/[^0-9]/g, '')" style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif;"></div>

        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0 40px;">
            <div>
                <div style="margin-bottom: 15px;"><label style="font-weight: 600; font-size: 14px; color: #374151;">Mapel <span style="color: #EF4444;">*</span></label><input type="text" name="mapel" value="<?php echo e(old('mapel', $tentor->mapel)); ?>" required style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif;"></div>
                <div style="margin-bottom: 15px;"><label style="font-weight: 600; font-size: 14px; color: #374151;">Grade <span style="color: #EF4444;">*</span></label><select name="grade" required style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif; cursor: pointer;"><option value="">Pilih</option><option value="A" <?php echo e(old('grade', $tentor->grade)=='A'?'selected':''); ?>>A</option><option value="B" <?php echo e(old('grade', $tentor->grade)=='B'?'selected':''); ?>>B</option></select></div>
                <div style="margin-bottom: 15px;"><label style="font-weight: 600; font-size: 14px; color: #374151;">HR SD</label><input type="text" name="hr_sd" value="<?php echo e(old('hr_sd', $tentor->hr_sd)); ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '')" style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif;"></div>
                <div style="margin-bottom: 15px;"><label style="font-weight: 600; font-size: 14px; color: #374151;">HR SMP</label><input type="text" name="hr_smp" value="<?php echo e(old('hr_smp', $tentor->hr_smp)); ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '')" style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif;"></div>
                <div style="margin-bottom: 15px;"><label style="font-weight: 600; font-size: 14px; color: #374151;">HR SMA</label><input type="text" name="hr_sma" value="<?php echo e(old('hr_sma', $tentor->hr_sma)); ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '')" style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif;"></div>
            </div>
            <div>
                <div style="margin-bottom: 15px;"><label style="font-weight: 600; font-size: 14px; color: #374151;">Uang Makan</label><input type="text" name="uang_makan" value="<?php echo e(old('uang_makan', $tentor->uang_makan)); ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '')" style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif;"></div>
                <div style="margin-bottom: 15px;"><label style="font-weight: 600; font-size: 14px; color: #374151;">Uang Transport</label><input type="text" name="uang_transport" value="<?php echo e(old('uang_transport', $tentor->uang_transport)); ?>" oninput="this.value = this.value.replace(/[^0-9]/g, '')" style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif;"></div>
                <div style="margin-bottom: 15px;"><label style="font-weight: 600; font-size: 14px; color: #374151;">Email <span style="color: #EF4444;">*</span></label><input type="email" name="email" value="<?php echo e(old('email', $tentor->user->email ?? '')); ?>" required style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif;"></div>
                <div style="margin-bottom: 15px;"><label style="font-weight: 600; font-size: 14px; color: #374151;">Username <span style="color: #EF4444;">*</span></label><input type="text" name="username" value="<?php echo e(old('username', $tentor->user->username ?? '')); ?>" required style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif;"></div>
            </div>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (form) {
            form.querySelectorAll('input:not([readonly]), select, textarea').forEach(function(i) {
            ...
            form.addEventListener('submit', function(e) {
                ...
                .then(function(result) {
                    if (result.data.success) {
                        if (pesanSukses) pesanSukses.textContent = result.data.message || 'Data tentor berhasil diupdate.';
                ...
                .catch(function(err) { tampilkanError(err.message); if (btnUpdate) { btnUpdate.disabled = false; btnUpdate.innerHTML = 'Update'; } });
            });
        }
    });
