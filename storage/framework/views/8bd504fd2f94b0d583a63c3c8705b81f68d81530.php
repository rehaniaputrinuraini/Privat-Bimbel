<div style="padding: 20px; font-family: 'Poppins', sans-serif; background: #FFFFFF; border-radius: 16px;">
    ...
    <div style="margin-bottom: 20px; padding-bottom: 14px; border-bottom: 1.5px solid #F3F4F6;">
        <h2 style="font-size: 19px; font-weight: 700; color: #111827; margin: 0;">Input Pemasukan/Pengeluaran</h2>
    ...
    <form id="mainForm" action="<?php echo e(route($role . '.laporan-keuangan.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0 40px;">
            <div>
                ...
                <div style="margin-bottom: 15px;">
                    <label style="display: block; font-weight: 600; font-size: 14px; color: #374151; margin-bottom: 6px;">Kategori <span style="color: #EF4444;">*</span></label>
                    <select name="kategori" id="select-kategori" onchange="updateLabel()" required 
                            style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; background: #FFFFFF; outline: none; color: #374151; cursor: pointer; font-size: 14px; font-family: 'Poppins', sans-serif;">
            ...
            <div>
                <div style="margin-bottom: 15px;">
                    <label id="label-rincian" style="display: block; font-weight: 600; font-size: 14px; color: #374151; margin-bottom: 6px;">Rincian Pemasukan <span style="color: #EF4444;">*</span></label>
...
<div id="modalSukses" style="display: none; position: fixed; z-index: 99999; left: 0; top: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.4); backdrop-filter: blur(3px); align-items: center; justify-content: center;">
    <div style="background: white; padding: 25px; border-radius: 20px; width: 320px; text-align: center; box-shadow: 0 15px 30px rgba(0,0,0,0.15); font-family: 'Poppins', sans-serif;">
        ...
        <p style="color: #6B7280; font-size: 13px; margin: 8px 0 20px 0;" id="pesanSukses">Data berhasil disimpan.</p>
...
<script>
    function updateLabel() {
        ...
        if (kategori === 'pengeluaran') {
            label.innerHTML = 'Rincian Pengeluaran <span style="color: #EF4444;">*</span>';
            input.placeholder = 'Masukkan Rincian Pengeluaran';
        } else {
            label.innerHTML = 'Rincian Pemasukan <span style="color: #EF4444;">*</span>';
            input.placeholder = 'Masukkan Rincian Pemasukan';
        }
    }
</script><?php /**PATH C:\xampp\htdocs\Privat-Bimbel\resources\views/dashboard/shared/laporan-keuangan/create-laporan-keuangan.blade.php ENDPATH**/ ?>