    ...
    <div style="background: #F9FAFB; border-radius: 15px; padding: 30px; border: 1.5px solid #E5E7EB; box-shadow: 0 4px 10px rgba(0,0,0,0.02);">
        <form action="<?php echo e(route($role . '.harga-paket.update', $paket->id_paket)); ?>" method="POST" id="mainForm">
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input type="tel" inputmode="numeric" name="harga" value="<?php echo e($paket->harga); ?>" placeholder="Masukkan Harga Paket" required
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input type="text" name="tingkat" value="<?php echo e($paket->tingkat); ?>" placeholder="Masukkan Tingkat" required 
                       style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #FFFFFF; outline: none; font-size: 14px;">
