...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input type="tel" inputmode="numeric" name="no_hp" value="<?php echo e(old('no_hp')); ?>" placeholder="Masukkan No HP" required
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0 40px;">
                ...
                <div>
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <input type="text" name="mapel" value="<?php echo e(old('mapel')); ?>" placeholder="Masukkan Mapel" required
                               style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #FFFFFF; outline: none; font-size: 14px;">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <input type="text" inputmode="numeric" name="hr_sd" value="<?php echo e(old('hr_sd')); ?>" placeholder="Masukkan HR SD"
                               onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                               oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                               style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #FFFFFF; outline: none; font-size: 14px;">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <input type="text" inputmode="numeric" name="hr_smp" value="<?php echo e(old('hr_smp')); ?>" placeholder="Masukkan HR SMP"
                               onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                               oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                               style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #FFFFFF; outline: none; font-size: 14px;">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <input type="text" inputmode="numeric" name="hr_sma" value="<?php echo e(old('hr_sma')); ?>" placeholder="Masukkan HR SMA"
                               onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                               oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                               style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #FFFFFF; outline: none; font-size: 14px;">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <input type="text" inputmode="numeric" name="uang_makan" value="<?php echo e(old('uang_makan')); ?>" placeholder="Masukkan Uang Makan"
                               onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                               oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                               style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #FFFFFF; outline: none; font-size: 14px;">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <input type="text" inputmode="numeric" name="uang_transport" value="<?php echo e(old('uang_transport')); ?>" placeholder="Masukkan Uang Transport"
                               onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                               oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                               style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #FFFFFF; outline: none; font-size: 14px;">
