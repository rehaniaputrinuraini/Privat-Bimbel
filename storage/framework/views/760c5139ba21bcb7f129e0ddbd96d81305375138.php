    ...
    <form id="mainForm" action="<?php echo e(route('superadmin.kelola-tentor.store')); ?>" method="POST">
        ...
        <div style="margin-bottom: 15px;">
            ...
            <textarea name="alamat" rows="2" placeholder="Masukkan Alamat" required
                      style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; background: #FFFFFF; outline: none; font-family: 'Poppins', sans-serif; font-size: 14px; resize: vertical;"><?php echo e(old('alamat')); ?></textarea>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0 40px;">
            <div>
                <div style="margin-bottom: 15px;">
                    ...
                    <input type="text" name="mapel" value="<?php echo e(old('mapel')); ?>" placeholder="Mapel" required style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif;">
                </div>
                <div style="margin-bottom: 15px;">
                    ...
                    <select name="grade" required style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif; cursor: pointer;">
                        ...
                        <option value="A" <?php echo e(old('grade')=='A'?'selected':''); ?>>A</option>
                        <option value="B" <?php echo e(old('grade')=='B'?'selected':''); ?>>B</option>
                    </select>
                </div>
                <div style="margin-bottom: 15px;">
                    <label style="font-weight: 600; font-size: 14px; color: #374151;">HR SD</label>
                    <input type="text" name="hr_sd" value="<?php echo e(old('hr_sd')); ?>" placeholder="HR SD" oninput="this.value = this.value.replace(/[^0-9]/g, '')" style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif;">
                </div>
                <div style="margin-bottom: 15px;">
                    <label style="font-weight: 600; font-size: 14px; color: #374151;">HR SMP</label>
                    <input type="text" name="hr_smp" value="<?php echo e(old('hr_smp')); ?>" placeholder="HR SMP" oninput="this.value = this.value.replace(/[^0-9]/g, '')" style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif;">
                </div>
                <div style="margin-bottom: 15px;">
                    <label style="font-weight: 600; font-size: 14px; color: #374151;">HR SMA</label>
                    <input type="text" name="hr_sma" value="<?php echo e(old('hr_sma')); ?>" placeholder="HR SMA" oninput="this.value = this.value.replace(/[^0-9]/g, '')" style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif;">
                </div>
            </div>
            <div>
                <div style="margin-bottom: 15px;">
                    <label style="font-weight: 600; font-size: 14px; color: #374151;">Uang Makan</label>
                    <input type="text" name="uang_makan" value="<?php echo e(old('uang_makan')); ?>" placeholder="Uang Makan" oninput="this.value = this.value.replace(/[^0-9]/g, '')" style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif;">
                </div>
                <div style="margin-bottom: 15px;">
                    <label style="font-weight: 600; font-size: 14px; color: #374151;">Uang Transport</label>
                    <input type="text" name="uang_transport" value="<?php echo e(old('uang_transport')); ?>" placeholder="Uang Transport" oninput="this.value = this.value.replace(/[^0-9]/g, '')" style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif;">
                </div>
                <div style="margin-bottom: 15px;">
                    <label style="font-weight: 600; font-size: 14px; color: #374151;">Email <span style="color: #EF4444;">*</span></label>
                    <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="Email" required style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif;">
                </div>
                <div style="margin-bottom: 15px;">
                    <label style="font-weight: 600; font-size: 14px; color: #374151;">Username <span style="color: #EF4444;">*</span></label>
                    <input type="text" name="username" value="<?php echo e(old('username')); ?>" placeholder="Username" required style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif;">
                </div>
                <div style="margin-bottom: 15px;">
                    <label style="font-weight: 600; font-size: 14px; color: #374151;">Password <span style="color: #EF4444;">*</span></label>
                    <div style="position: relative; width: 100%;">
                        <input type="password" name="password" id="passwordTentor" placeholder="Masukkan Password" required autocomplete="new-password"
                               style="width: 100%; padding: 12px 45px 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif;">
                        <button type="button"
                                onclick="
                                    var p = document.getElementById('passwordTentor');
                                    var e = document.getElementById('eyePasswordTentor');
                                    if (p.type === 'password') {
                                        p.type = 'text';
                            ...
                            <i class="fas fa-eye-slash" id="eyePasswordTentor"></i>
                        </button>
                    </div>
                </div>
            </div>
...
</div><?php /**PATH C:\xampp\htdocs\Privat-Bimbel\resources\views/dashboard/superadmin/kelola-tentor/create-tentor.blade.php ENDPATH**/ ?>