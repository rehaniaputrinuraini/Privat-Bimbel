    ...
    <div style="background: #F9FAFB; border-radius: 15px; padding: 30px; border: 1.5px solid #E5E7EB; box-shadow: 0 4px 10px rgba(0,0,0,0.02);">
        <form action="<?php echo e(route($role . '.murid.update', $murid->id_murid)); ?>" method="POST" id="mainForm">
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input type="text" name="nama_lengkap_murid" value="<?php echo e($murid->nama_lengkap_murid); ?>" placeholder="Masukkan Nama Lengkap" required 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input type="text" name="kelas" value="<?php echo e($murid->kelas); ?>" placeholder="Masukkan Kelas" required 
                       style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #FFFFFF; outline: none; font-size: 14px;">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input type="text" name="asal_sekolah" value="<?php echo e($murid->asal_sekolah); ?>" placeholder="Masukkan Asal Sekolah" required 
                       style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #FFFFFF; outline: none; font-size: 14px;">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="margin-bottom: 15px;">
                ...
                <textarea name="alamat_murid" rows="3" placeholder="Masukkan Alamat Lengkap" required 
                          style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #FFFFFF; outline: none; font-family: 'Poppins', sans-serif; font-size: 14px; resize: vertical;"><?php echo e($murid->alamat_murid); ?></textarea>
                <?php $__errorArgs = ['alamat_murid'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <small style="color: red;"><?php echo e($message); ?></small> <?php unset($message);
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0 40px; align-items: start;">
                ...
                <div>
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <input type="tel" inputmode="numeric" name="no_hp_murid" value="<?php echo e($murid->no_hp_murid); ?>" placeholder="Masukkan No HP Siswa" required
                               onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                               oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                               style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #FFFFFF; outline: none; font-size: 14px;">
                        <?php $__errorArgs = ['no_hp_murid'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <small style="color: red;"><?php echo e($message); ?></small> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <input type="text" name="nama_orang_tua" value="<?php echo e($murid->nama_orang_tua); ?>" placeholder="Masukkan Nama Orang Tua" required 
                               style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #FFFFFF; outline: none; font-size: 14px;">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <input type="tel" inputmode="numeric" name="no_hp_orang_tua" value="<?php echo e($murid->no_hp_orang_tua); ?>" placeholder="Masukkan No HP Orang Tua" required
                               onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                               oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                               style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #FFFFFF; outline: none; font-size: 14px;">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <input type="tel" inputmode="numeric" name="tahun_masuk" value="<?php echo e($murid->tahun_masuk); ?>" placeholder="Masukkan Tahun Masuk" required
