            ...
            <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 13px; white-space: nowrap;">
                ...
                <tbody id="tableBody" style="color: #374151;">
                    ...
                    <tr style="border-bottom: 1px solid #F3F4F6;">
                        ...
                        <td style="padding: 15px;">TE<?php echo e(str_pad($t->id_pegawai, 4, '0', STR_PAD_LEFT)); ?></td>
                        <td style="padding: 15px; max-width: 130px; overflow: hidden; text-overflow: ellipsis;"><?php echo e($t->nama_lengkap ?? '-'); ?></td>
                        ...
                        <td style="padding: 15px; text-align: center;">
                            ...
                            <?php elseif($t->grade == 'B'): ?>
                                <span style="background: #E0E7FF; color: #3730A3; padding: 4px 10px; border-radius: 20px; font-size: 11px;">Grade B</span>
                            <?php else: ?>
                                <span style="color: #9CA3AF;">-</span>
                            <?php endif; ?>
                        </td>
                        <td style="padding: 15px; text-align: right;"><?php echo e($t->hr_sd ? 'Rp '.number_format($t->hr_sd,0,',','.') : '-'); ?></td>
                        <td style="padding: 15px; text-align: right;"><?php echo e($t->hr_smp ? 'Rp '.number_format($t->hr_smp,0,',','.') : '-'); ?></td>
                        <td style="padding: 15px; text-align: right;"><?php echo e($t->hr_sma ? 'Rp '.number_format($t->hr_sma,0,',','.') : '-'); ?></td>
                        <td style="padding: 15px; text-align: right;"><?php echo e($t->uang_makan ? 'Rp '.number_format($t->uang_makan,0,',','.') : '-'); ?></td>
                        <td style="padding: 15px; text-align: right;"><?php echo e($t->uang_transport ? 'Rp '.number_format($t->uang_transport,0,',','.') : '-'); ?></td>
                    </tr>
