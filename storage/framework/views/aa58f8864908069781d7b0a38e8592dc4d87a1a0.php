        ...
        <div style="display: flex; gap: 5px;">
            ...
            <?php for($i = $start; $i <= $end; $i++): ?>
                <?php if($i == $pemasukanLain->currentPage()): ?>
                    <button style="width:35px;height:35px;border-radius:8px;background:#10B981;color:white;border:none;font-weight:600;font-family:'Poppins',sans-serif;"><?php echo e($i); ?></button>
                <?php else: ?>
...
<script>
    ...
    fetch("<?php echo e(route($role . '.pemasukan-lain.create')); ?>").then(r => r.text()).then(html => {
