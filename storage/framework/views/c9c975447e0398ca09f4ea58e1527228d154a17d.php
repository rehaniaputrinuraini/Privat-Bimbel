<div style="padding: 20px; font-family: 'Poppins', sans-serif; background: #FFFFFF; border-radius: 16px;">
    ...
    <form action="<?php echo e(route($role . '.master-data.periode.update', $periode->id_periode)); ?>" method="POST">
        <?php echo csrf_field(); ?>
        ...
        <div style="margin-bottom: 15px;">
            ...
            <input type="text" name="tahun_periode" value="<?php echo e(old('tahun_periode', $periode->tahun_periode)); ?>" placeholder="Contoh: 2024/2025" maxlength="9" required
        ...
        <div style="margin-bottom: 15px;">
            ...
            <input type="date" name="tanggal_mulai" 
                   value="<?php echo e(old('tanggal_mulai', $periode->tanggal_mulai ? date('Y-m-d', strtotime($periode->tanggal_mulai)) : '')); ?>" 
                   required
                   style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; background: #FFFFFF; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif;">
        </div>
        ...
        <div style="margin-bottom: 15px;">
            ...
            <input type="date" name="tanggal_selesai" 
                   value="<?php echo e(old('tanggal_selesai', $periode->tanggal_selesai ? date('Y-m-d', strtotime($periode->tanggal_selesai)) : '')); ?>" 
                   required
                   style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; background: #FFFFFF; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif;">
        </div>
...
</div><?php /**PATH C:\xampp\htdocs\Privat-Bimbel\resources\views/dashboard/shared/master-data/periode/edit.blade.php ENDPATH**/ ?>