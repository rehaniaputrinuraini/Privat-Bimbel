    ...
    <div class="min-h-screen flex items-center justify-center p-4">
        <div class="w-full max-w-md">
            ...
            <div class="flex items-center justify-center gap-3 mb-8">
                <img src="<?php echo e(asset('images/logo/foto_logo.png')); ?>" alt="Logo" class="h-12 w-auto">
            ...
            <div class="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-500 text-sm mt-2 leading-relaxed">
                        ...
                        <span class="font-semibold text-gray-700"><?php echo e(session('otp_email')); ?></span>
                    </p>
                </div>

                
                <form method="POST" action="<?php echo e(route('otp.check')); ?>" id="otp-form">
                    <?php echo csrf_field(); ?>
                ...
                <div class="mt-8 text-center">
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-50">
                        <a href="<?php echo e(route('login')); ?>" class="text-xs font-semibold text-gray-400 hover:text-[#4D0B87] transition-colors">
...
</html><?php /**PATH C:\xampp\htdocs\privat-bimbel\resources\views/auth/verify-email.blade.php ENDPATH**/ ?>