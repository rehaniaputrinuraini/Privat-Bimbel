<div style="padding: 20px; font-family: 'Poppins', sans-serif; background: #FFFFFF; border-radius: 16px;">
    ...
    <div style="margin-bottom: 20px; padding-bottom: 14px; border-bottom: 1.5px solid #F3F4F6;">
        <h2 style="font-size: 19px; font-weight: 700; color: #111827; margin: 0;">Edit Ruang</h2>
        <p style="color: #9CA3AF; font-size: 12px; margin: 2px 0 0 0;">Perbarui data ruang</p>
    </div>
    ...
    <form action="<?php echo e(route($role . '.master-data.ruang.update', $ruang->id_ruang)); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>
        
        <div style="margin-bottom: 15px;">
            <label style="display: block; font-weight: 600; font-size: 14px; color: #374151; margin-bottom: 6px;">ID Ruang</label>
            <input type="text" value="RG<?php echo e(str_pad($ruang->id_ruang, 4, '0', STR_PAD_LEFT)); ?>" readonly 
        ...
        <div style="margin-bottom: 15px;">
            <label style="display: block; font-weight: 600; font-size: 14px; color: #374151; margin-bottom: 6px;">Nama Ruang <span style="color: #EF4444;">*</span></label>
            <input type="text" name="nama_ruang" value="<?php echo e(old('nama_ruang', $ruang->nama_ruang)); ?>" required maxlength="2"
...
</div><?php /**PATH C:\xampp\htdocs\Privat-Bimbel\resources\views/dashboard/shared/master-data/ruang/edit.blade.php ENDPATH**/ ?>