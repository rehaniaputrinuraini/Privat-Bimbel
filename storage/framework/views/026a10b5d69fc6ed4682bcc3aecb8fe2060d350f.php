    ...
    <div style="background: #F9FAFB; border-radius: 15px; padding: 30px; border: 1.5px solid #E5E7EB; box-shadow: 0 4px 10px rgba(0,0,0,0.02);" data-aos="fade-up">
        ...
        <form action="<?php echo e(route('superadmin.kelola-tentor.update', $tentor->id_tentor)); ?>" method="POST" id="mainForm">
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input type="text" name="nama_lengkap_tentor" value="<?php echo e(old('nama_lengkap_tentor', $tentor->nama_lengkap_tentor)); ?>" placeholder="Masukkan Nama Lengkap" required
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="margin-bottom: 15px;">
                ...
                <textarea name="alamat_tentor" rows="2" placeholder="Masukkan Alamat" required
                          style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #FFFFFF; outline: none; font-family: 'Poppins', sans-serif; font-size: 14px; resize: vertical;"><?php echo e(old('alamat_tentor', $tentor->alamat_tentor)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input type="tel" inputmode="numeric" name="no_hp_tentor" value="<?php echo e(old('no_hp_tentor', $tentor->no_hp_tentor)); ?>" placeholder="Masukkan No HP" required
