            ...
            <div style="flex: 1; background: white; padding: 40px 20px; border-radius: 20px; border: 1px solid #E5E7EB; box-shadow: 0 4px 20px rgba(0,0,0,0.05); text-align: center;">
                ...
                <div class="foto-wrapper">
                    <div class="foto-inner">
                        <?php if($user->foto): ?>
                            <img id="fotoProfilPreview" src="<?php echo e(asset('storage/' . $user->foto)); ?>" alt="Foto Profil">
                            <span id="inisialText" style="display: none; background: #4D0B87; color: white; font-size: 70px; font-weight: 800;"><?php echo e(strtoupper(substr($pegawai->nama_lengkap ?? $user->username ?? 'U', 0, 2))); ?></span>
                        <?php else: ?>
                            <span id="inisialText" style="display: flex; background: #4D0B87; color: white; font-size: 70px; font-weight: 800;"><?php echo e(strtoupper(substr($pegawai->nama_lengkap ?? $user->username ?? 'U', 0, 2))); ?></span>
