...
<div style="padding: 10px; font-family: 'Poppins', sans-serif;">
    ...
    <div style="background: #F9FAFB; border-radius: 15px; padding: 30px; border: 1.5px solid #E5E7EB; box-shadow: 0 4px 10px rgba(0,0,0,0.02);">
        <form action="<?php echo e(route($role . '.master-data.harga-paket.update', $paket->id_paket)); ?>" method="POST" id="mainForm">
            <?php echo csrf_field(); ?>
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input type="tel" inputmode="numeric" name="harga" value="<?php echo e(old('harga', $paket->harga)); ?>" placeholder="Masukkan Harga Paket" required
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Privat-Bimbel\resources\views/dashboard/shared/master-data/harga-paket/edit.blade.php ENDPATH**/ ?>