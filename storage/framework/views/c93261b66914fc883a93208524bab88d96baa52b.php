...
<?php $__env->startSection('title', 'Tambah Periode'); ?>
    ...
    <div style="background: #F9FAFB; border-radius: 15px; padding: 30px; border: 1.5px solid #E5E7EB;">
        <form action="<?php echo e(route($role . '.master-data.periode.store')); ?>" method="POST" id="mainForm">
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input type="text" name="tahun_periode" value="<?php echo e(old('tahun_periode')); ?>" 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Privat-Bimbel\resources\views/dashboard/shared/master-data/periode/create.blade.php ENDPATH**/ ?>