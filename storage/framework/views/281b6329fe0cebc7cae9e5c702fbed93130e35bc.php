...
<div style="padding: 10px; font-family: 'Poppins', sans-serif;">
    ...
    <div style="background: #F9FAFB; border-radius: 15px; padding: 30px; border: 1.5px solid #E5E7EB; box-shadow: 0 4px 10px rgba(0,0,0,0.02);">
        <form action="<?php echo e(route($role . '.master-data.harga-paket.store')); ?>" method="POST" id="mainForm">
            <?php echo csrf_field(); ?>
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input type="tel" inputmode="numeric" name="harga" value="<?php echo e(old('harga')); ?>" placeholder="Masukkan Harga Paket" required
            ...
            <div style="margin-bottom: 15px;">
                ...
                <?php if(count($tingkatTersedia) == 0): ?>
                    <small style="color: #EF4444;">
                        <i class="fas fa-info-circle"></i> Semua tingkat (SD, SMP, SMA) sudah terpakai.
                    </small>
                <?php endif; ?>
...
<div id="modalBatal" style="display: none; position: fixed; z-index: 9999; left: 0; top: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.4); backdrop-filter: blur(3px); align-items: center; justify-content: center;">
    <div style="background: white; padding: 25px; border-radius: 20px; width: 320px; text-align: center; box-shadow: 0 15px 30px rgba(0,0,0,0.15); font-family: 'Poppins', sans-serif;">
        ...
        <div style="display: flex; gap: 10px; justify-content: center;">
            ...
            <a href="<?php echo e(route($role . '.master-data.harga-paket')); ?>" style="flex: 1; text-decoration: none;">
    ...
    function bukaModalBatal() { 
        if (formChanged) {
            ...
            document.getElementById('confirmPindahBtn').onclick = function() {
                formChanged = false;
                window.location.href = "<?php echo e(route($role . '.master-data.harga-paket')); ?>";
            };
        } else {
        ...
        sidebarLinks.forEach(link => {
            link.addEventListener('click', function(e) {
                if (formChanged) {
                    ...
                    if (targetUrl && targetUrl !== '#' && !this.classList.contains('logout-btn')) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Privat-Bimbel\resources\views/dashboard/shared/master-data/harga-paket/create.blade.php ENDPATH**/ ?>