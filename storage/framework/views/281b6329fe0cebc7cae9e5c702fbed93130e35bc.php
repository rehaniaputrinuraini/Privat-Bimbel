<div style="padding: 20px; font-family: 'Poppins', sans-serif; background: #FFFFFF; border-radius: 16px;">
    ...
    <div style="margin-bottom: 20px; padding-bottom: 14px; border-bottom: 1.5px solid #F3F4F6;">
        <h2 style="font-size: 19px; font-weight: 700; color: #111827; margin: 0;">Input Harga Paket</h2>
    ...
    <form action="<?php echo e(route($role . '.master-data.harga-paket.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        ...
        <div style="margin-bottom: 15px;">
            ...
            <input type="text" name="harga" value="<?php echo e(old('harga')); ?>" placeholder="Masukkan Harga Paket" required
        ...
        <div style="margin-bottom: 15px;">
            <label style="display: block; font-weight: 600; font-size: 14px; color: #374151; margin-bottom: 6px;">Tingkat <span style="color: #EF4444;">*</span></label>
            <select name="tingkat" required style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; background: #FFFFFF; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif; cursor: pointer;">
            ...
            <?php if(count($tingkatTersedia) == 0): ?>
                <small style="color: #EF4444;"><i class="fas fa-info-circle"></i> Semua tingkat (SD, SMP, SMA) sudah terpakai.</small>
            <?php endif; ?>
        </div>
...
</div><?php /**PATH C:\xampp\htdocs\Privat-Bimbel\resources\views/dashboard/shared/master-data/harga-paket/create.blade.php ENDPATH**/ ?>