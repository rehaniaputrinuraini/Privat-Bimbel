                ...
                <div style="position: relative; width: 100%;">
                    ...
                    <button type="button" id="togglePassword"
                            onclick="
                                ...
                                var e = document.getElementById('eyePassword');
                                if (p.type === 'password') {
                                    p.type = 'text';
                            ...
                            "
                            style="position: absolute; right: 12px; top: 50%; transform: translateY(-50%); background: none; border: none; cursor: pointer; color: #9CA3AF; font-size: 16px; padding: 0; transition: color 0.2s;">
                        <i class="fas fa-eye-slash" id="eyePassword"></i>
                    </button>
                </div>
            </div>
        </div>
