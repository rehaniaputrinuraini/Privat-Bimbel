    ...
    <div style="background: #F9FAFB; border-radius: 12px; padding: 20px; margin-bottom: 20px;">
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
            ...
            <div>
                ...
                <p style="color: #111827; font-weight: 600; font-size: 15px; margin: 0;"><?php echo e($hariUnik ?? 0); ?> Hari</p>
            </div>
        </div>
    </div>
            ...
            <table style="width: 100%; border-collapse: collapse; font-size: 13px; font-family: 'Poppins', sans-serif;">
                ...
                <tr style="background: #FAFAFA; font-weight: 600;">
                    <td style="padding: 10px 12px; text-align: left;">
                        Uang Makan
                        <br><small style="color: #9CA3AF; font-weight: 400;">(Rp <?php echo e(number_format($uangMakanPerHari, 0, ',', '.')); ?> × <?php echo e($hariUnik ?? 0); ?> hari)</small>
                     </td>
                ...
                <tr style="background: #FAFAFA; font-weight: 600;">
                    <td style="padding: 10px 12px; text-align: left;">
                        Uang Transport
                        <br><small style="color: #9CA3AF; font-weight: 400;">(Rp <?php echo e(number_format($uangTransportPerHari, 0, ',', '.')); ?> × <?php echo e($hariUnik ?? 0); ?> hari)</small>
                    </td>
