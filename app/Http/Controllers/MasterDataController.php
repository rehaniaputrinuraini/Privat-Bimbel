...
use App\Models\Periode; // ✅ TAMBAH USE
...
class MasterDataController extends Controller
{
    ...
    public function storePaket(Request $request)
    {
        ...
        return redirect()->route('superadmin.master-data')->with('success_paket', 'Harga paket berhasil ditambahkan');
    }
    ...
    public function updatePaket(Request $request, $id)
    {
        ...
        return redirect()->route('superadmin.master-data')->with('success_paket', 'Harga paket berhasil diperbarui');
    }

    public function destroyPaket($id)
    {
        HargaPaket::destroy($id);
        return redirect()->route('superadmin.master-data')->with('success_paket', 'Harga paket berhasil dihapus');
    }
    ...
    public function createKelas()
    {
        ...
        $periodeList = Periode::orderBy('tahun_mulai', 'desc')->get(); // ✅ Tambah
    ...
    public function storeKelas(Request $request)
    {
        $request->validate([
            ...
            'id_periode' => 'required|exists:ms_periode,id_periode', // ✅ Validasi
        ]);
        ...
        return redirect()->route('superadmin.master-data')->with('success_kelas', 'Kelas berhasil ditambahkan');
    }
    ...
    public function updateKelas(Request $request, $id)
    {
        ...
        return redirect()->route('superadmin.master-data')->with('success_kelas', 'Kelas berhasil diperbarui');
    }

    public function destroyKelas($id)
    {
        Kelas::destroy($id);
        return redirect()->route('superadmin.master-data')->with('success_kelas', 'Kelas berhasil dihapus');
    }
    ...
    public function storeRuang(Request $request)
    {
        ...
        return redirect()->route('superadmin.master-data')->with('success_ruang', 'Ruang berhasil ditambahkan');
    }
    ...
    public function updateRuang(Request $request, $id)
    {
        ...
        return redirect()->route('superadmin.master-data')->with('success_ruang', 'Ruang berhasil diperbarui');
    }

    public function destroyRuang($id)
    {
        Ruang::destroy($id);
        return redirect()->route('superadmin.master-data')->with('success_ruang', 'Ruang berhasil dihapus');
    }

    // =============================================
    // ✅ CRUD PERIODE (TAMBAHAN BARU)
    // =============================================
    ...
    public function storePeriode(Request $request)
    {
        ...
        return redirect()->route('superadmin.master-data')
