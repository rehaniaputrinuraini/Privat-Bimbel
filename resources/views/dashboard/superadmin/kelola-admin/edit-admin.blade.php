    ...
    <form id="mainForm" action="{{ route('superadmin.kelola-admin.update', $admin->id_user) }}" method="POST">
        ...
        <div style="margin-bottom: 15px;">
            ...
            <input type="text" value="AD{{ str_pad($admin->id_user, 4, '0', STR_PAD_LEFT) }}" readonly 
                   style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #F3F4F6; outline: none; color: #6B7280; font-size: 14px; font-family: 'Poppins', sans-serif;">
        </div>
