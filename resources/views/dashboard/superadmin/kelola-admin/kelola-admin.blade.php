        ...
        <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 13px; white-space: nowrap;">
            ...
            <tbody id="tableBody" style="color: #374151;">
                ...
                <tr style="border-bottom: 1px solid #F3F4F6; transition: 0.2s;" onmouseover="this.style.background='#F9FAFB'" onmouseout="this.style.background='transparent'">
                    ...
                    <td style="padding: 15px; max-width: 150px; overflow: hidden; text-overflow: ellipsis;">{{ $item->pegawai->nama_lengkap ?? '-' }}</td>
                    <td style="padding: 15px; max-width: 120px; overflow: hidden; text-overflow: ellipsis;" title="{{ $item->pegawai->alamat ?? '-' }}">{{ $item->pegawai->alamat ?? '-' }}</td>
                    ...
                    <td style="padding: 15px; max-width: 180px; overflow: hidden; text-overflow: ellipsis;">{{ $item->email }}</td>
