        ...
        <form action="{{ route('superadmin.kelola-tentor.update', $tentor->id_tentor) }}" method="POST" id="mainForm">
            ...
            <div style="margin-bottom: 15px;">
                ...
                <textarea name="alamat_tentor" rows="2" placeholder="Masukkan Alamat" required
                          style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #FFFFFF; outline: none; font-family: 'Poppins', sans-serif; font-size: 14px; resize: vertical;">{{ old('alamat_tentor', $tentor->alamat_tentor) }}</textarea>
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input type="tel" inputmode="numeric" name="no_hp_tentor" value="{{ old('no_hp_tentor', $tentor->no_hp_tentor) }}" placeholder="Masukkan No HP" required
