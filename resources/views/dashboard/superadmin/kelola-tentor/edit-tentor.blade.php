...
<div style="padding: 10px; font-family: 'Poppins', sans-serif;">
    ...
    <div style="background: #F9FAFB; border-radius: 15px; padding: 30px; border: 1.5px solid #E5E7EB; box-shadow: 0 4px 10px rgba(0,0,0,0.02);" data-aos="fade-up">
        ...
        <form action="{{ route('superadmin.kelola-tentor.update', $tentor->id_pegawai) }}" method="POST" id="mainForm">
            @csrf
            @method('PUT')
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input type="text" value="TE{{ str_pad($tentor->id_pegawai, 4, '0', STR_PAD_LEFT) }}" readonly 
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input type="text" name="nama_lengkap" value="{{ old('nama_lengkap', $tentor->nama_lengkap) }}" placeholder="Masukkan Nama Lengkap" required
            ...
            <div style="margin-bottom: 15px;">
                ...
                <textarea name="alamat" rows="2" placeholder="Masukkan Alamat" required
                          style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #FFFFFF; outline: none; font-family: 'Poppins', sans-serif; font-size: 14px; resize: vertical;">{{ old('alamat', $tentor->alamat) }}</textarea>
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input type="tel" inputmode="numeric" name="no_hp" value="{{ old('no_hp', $tentor->no_hp) }}" placeholder="Masukkan No HP" required
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0 40px;">
                ...
                <div>
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <input type="text" name="mapel" value="{{ old('mapel', $tentor->mapel) }}" placeholder="Masukkan Mapel" required
                               style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #FFFFFF; outline: none; font-size: 14px;">
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <input type="text" inputmode="numeric" name="hr_sd" value="{{ old('hr_sd', $tentor->hr_sd) }}" placeholder="Masukkan HR SD"
                               onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                               oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                               style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #FFFFFF; outline: none; font-size: 14px;">
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <input type="text" inputmode="numeric" name="hr_smp" value="{{ old('hr_smp', $tentor->hr_smp) }}" placeholder="Masukkan HR SMP"
                               onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                               oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                               style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #FFFFFF; outline: none; font-size: 14px;">
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <input type="text" inputmode="numeric" name="hr_sma" value="{{ old('hr_sma', $tentor->hr_sma) }}" placeholder="Masukkan HR SMA"
                               onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                               oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                               style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #FFFFFF; outline: none; font-size: 14px;">
                ...
                <div>
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <input type="text" inputmode="numeric" name="uang_makan" value="{{ old('uang_makan', $tentor->uang_makan) }}" placeholder="Masukkan Uang Makan"
                               onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                               oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                               style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #FFFFFF; outline: none; font-size: 14px;">
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <input type="text" inputmode="numeric" name="uang_transport" value="{{ old('uang_transport', $tentor->uang_transport) }}" placeholder="Masukkan Uang Transport"
                               onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                               oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                               style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1px solid #E5E7EB; background: #FFFFFF; outline: none; font-size: 14px;">
