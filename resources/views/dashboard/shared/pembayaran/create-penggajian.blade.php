<div style="padding: 20px; font-family: 'Poppins', sans-serif; background: #FFFFFF; border-radius: 16px;">
    ...
    <div style="margin-bottom: 20px; padding-bottom: 14px; border-bottom: 1.5px solid #F3F4F6;">
        <h2 style="font-size: 19px; font-weight: 700; color: #111827; margin: 0;">Input Penggajian Manual</h2>
        <p style="color: #9CA3AF; font-size: 12px; margin: 2px 0 0 0;">Untuk gaji admin, bonus, atau di luar sistem</p>
    </div>
    ...
    <form id="mainForm" action="{{ route($role . '.penggajian.store-manual') }}" method="POST">
        @csrf
        ...
        <div style="margin-bottom: 15px;">
            <label style="display: block; font-weight: 600; font-size: 14px; color: #374151; margin-bottom: 6px;">Nama Penerima <span style="color: #EF4444;">*</span></label>
            <input type="text" name="nama_penerima" placeholder="Nama admin/pegawai" required
                   style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; background: #FFFFFF; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif;">
        </div>

        <div style="margin-bottom: 15px;">
            <label style="display: block; font-weight: 600; font-size: 14px; color: #374151; margin-bottom: 6px;">Jenis <span style="color: #EF4444;">*</span></label>
        ...
        <div style="margin-bottom: 15px;">
            <label style="display: block; font-weight: 600; font-size: 14px; color: #374151; margin-bottom: 6px;">Keperluan <span style="color: #EF4444;">*</span></label>
            <input type="text" name="keperluan" placeholder="Contoh: Gaji Admin, Bonus, dll" required
                   style="width: 100%; padding: 12px 15px; border-radius: 12px; border: 1.5px solid #E5E7EB; background: #FFFFFF; outline: none; font-size: 14px; font-family: 'Poppins', sans-serif;">
        </div>
        ...
        <div style="margin-bottom: 15px;">
            ...
            <input type="text" name="total_pembayaran" placeholder="Masukkan Jumlah" required 
...
<div id="modalSukses" style="display: none; position: fixed; z-index: 99999; left: 0; top: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.4); backdrop-filter: blur(3px); align-items: center; justify-content: center; font-family: 'Poppins', sans-serif;">
    <div style="background: white; padding: 25px; border-radius: 20px; width: 320px; text-align: center; box-shadow: 0 15px 30px rgba(0,0,0,0.15);">
        ...
        <p style="color: #6B7280; font-size: 13px; margin: 8px 0 20px 0;" id="pesanSukses">Penggajian berhasil disimpan.</p>
