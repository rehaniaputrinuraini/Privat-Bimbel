...
<div style="padding: 10px; font-family: 'Poppins', sans-serif;">
    ...
    <div style="margin-bottom: 25px;">
        ...
        <h1 style="font-size: 28px; font-weight: 800; color: #111827; margin: 0;">Laporan Keuangan</h1>
        <p style="color: #6B7280; font-size: 14px; margin-top: 5px;">Data Laporan Arus Kas Masuk dan Keluar</p>
    </div>
    ...
    {{-- 3. FILTER DAN TOMBOL TAMBAH (PERBAIKAN DI SINI) --}}
    <div style="display: flex; gap: 15px; align-items: center; margin-bottom: 20px;">
        <div style="position: relative; flex: 3;">
            <i class="fas fa-search" style="position: absolute; left: 15px; top: 50%; transform: translateY(-50%); color: #9CA3AF;"></i>
            <input type="text" placeholder="Cari..." style="width: 100%; padding: 12px 45px; border-radius: 12px; border: 2px solid #3B82F6; outline: none;">
        </div>
        <div style="flex: 1; display: flex; justify-content: flex-end;">
            {{-- PERBAIKAN: Tombol dibungkus dengan tag <a> yang mengarah ke route create --}}
    ...
    <div style="display: flex; gap: 15px; margin-bottom: 35px;">
        <select style="flex: 1; padding: 12px; border-radius: 12px; border: 1px solid #E5E7EB; background: white;"><option>Maret</option></select>
        <select style="flex: 2; padding: 12px; border-radius: 12px; border: 1px solid #E5E7EB; background: white;"><option>---Kategori---</option></select>
    ...
    <button style="width: 100%; background: #4AB462; color: white; border: none; padding: 18px; border-radius: 15px; font-size: 18px; font-weight: 800; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 15px; box-shadow: 0 4px 15px rgba(34, 197, 94, 0.3); margin-bottom: 50px;">
