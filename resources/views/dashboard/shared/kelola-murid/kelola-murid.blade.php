{{-- =============================================
     Dashboard Shared - Kelola Murid (REVISI STANDAR)
...
<div style="width: 100%;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px; gap: 15px;">
        <div style="display: flex; align-items: center; gap: 12px; flex: 1;">
            <select style="padding: 10px 12px; border-radius: 12px; border: 1px solid #E5E7EB; color: #6B7280; font-size: 13px; min-width: 160px; background: white; outline: none;">
    ...
    {{-- ── 3. TABEL UTAMA (KEMBALI KE DESAIN SEMULA/KOTAK) ── --}}
            ...
            <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 13px; white-space: nowrap;">
                <thead>
                    <tr style="background: #F3E8FF; color: #111827;">
                        ...
                        <th style="padding: 15px; font-weight: 700; text-align: center;">Kelas</th>
                        ...
                        <th style="padding: 15px; font-weight: 700; text-align: center;">Pilihan Paket</th>
                        <th style="padding: 15px; font-weight: 700; text-align: center;">Tahun</th>
                ...
                <tbody>
                    ...
                    <tr style="border-bottom: 1px solid #F3F4F6; transition: 0.2s;" onmouseover="this.style.background='#F9FAFB'" onmouseout="this.style.background='transparent'">
                        ...
                        <td style="padding: 15px; font-weight: 600; color: #111827;">{{ $m->nama_lengkap_murid }}</td>
                        <td style="padding: 15px; text-align: center;">{{ $m->kelas }}</td>
