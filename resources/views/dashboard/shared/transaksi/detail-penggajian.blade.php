            ...
            <table style="width: 100%; border-collapse: collapse; font-size: 12px; font-family: 'Poppins', sans-serif;">
                ...
                <tbody>
                    ...
                    <tr style="border-bottom: 1px solid #F3F4F6; {{ $i % 2 == 0 ? 'background: #FAFAFA;' : '' }}">
                        <td style="padding: 10px 12px; text-align: center;">{{ $i + 1 }}</td>
                        <td style="padding: 10px 12px; text-align: center; font-weight: 500;">{{ $d->tanggal }}</td>
                        <td style="padding: 10px 12px; text-align: center; color: #6B7280;">{{ $d->hari }}</td>
                        <td style="padding: 10px 12px; text-align: left;">{{ $d->kelas }}</td>
        ...
        <div style="margin-top: 20px; border-radius: 10px; border: 1px solid #E5E7EB; overflow: hidden;">
            <table style="width: 100%; border-collapse: collapse; font-size: 13px; font-family: 'Poppins', sans-serif;">
                <tr style="background: #F3E8FF; font-weight: 700;">
                    <td style="padding: 10px 12px; text-align: left;">Total Honor ({{ $detailPresensi->count() }} Sesi)</td>
