<div style="padding: 20px; font-family: 'Poppins', sans-serif; background: #FFFFFF; border-radius: 16px;">
    ...
    <form action="{{ route($role . '.master-data.harga-paket.store') }}" method="POST">
        @csrf
        ...
        <div style="margin-bottom: 15px;">
            ...
            <input type="text" name="harga" value="{{ old('harga') }}" placeholder="Masukkan Harga Paket" required
