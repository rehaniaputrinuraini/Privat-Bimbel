<div style="padding: 20px; font-family: 'Poppins', sans-serif; background: #FFFFFF; border-radius: 16px;">
    ...
    <form action="{{ route($role . '.master-data.periode.store') }}" method="POST">
        @csrf
        ...
        <div style="margin-bottom: 15px;">
            ...
            <input type="text" name="tahun_periode" value="{{ old('tahun_periode') }}" placeholder="Contoh: 2024/2025" maxlength="9" required
