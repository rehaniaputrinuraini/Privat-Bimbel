...
<div style="padding: 10px; font-family: 'Poppins', sans-serif;">
    ...
    <div style="background: #F9FAFB; border-radius: 15px; padding: 30px; border: 1.5px solid #E5E7EB; box-shadow: 0 4px 10px rgba(0,0,0,0.02);">
        <form action="{{ route($role . '.ruang.update', $ruang->id_ruang) }}" method="POST" id="mainForm">
            @csrf
            @method('PUT')
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input type="text" name="nama_ruang" value="{{ old('nama_ruang', $ruang->nama_ruang) }}" placeholder="Masukkan nama ruang" required maxlength="2"
