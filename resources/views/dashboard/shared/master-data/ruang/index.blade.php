...
<div style="padding: 10px; font-family: 'Poppins', sans-serif;">
    <div style="margin-bottom: 25px;">
        ...
        <p style="color: #374151; font-size: 14px; margin: 4px 0 0 0;">Manajemen data ruangan</p>
    </div>
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <thead style="background: #F3E8FF;">
                <tr>
                    ...
                    <th style="padding: 15px;">Nama Ruang</th>
            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid #F3F4F6;">
                    ...
                    <td style="padding: 15px; text-align: center;">
                        <a href="{{ route($role . '.ruang.edit', $item->id_ruang) }}" style="background: #5EB37E; color: white; padding: 6px 12px; border-radius: 6px; text-decoration: none;">Edit</a>
                        <form action="{{ route($role . '.ruang.destroy', $item->id_ruang) }}" method="POST" style="display: inline;">
                            @csrf @method('DELETE')
                ...
                @empty
                <tr><td colspan="3" style="padding: 40px; text-align: center;">Belum ada data ruang</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
