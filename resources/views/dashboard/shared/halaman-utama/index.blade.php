{{-- =============================================
     Dashboard Shared - Halaman Utama (REVISI UKURAN JUDUL)
...
<div style="margin-bottom: 25px;">
    ...
    {{-- UKURAN DIUBAH DARI 32px KE 26px AGAR TIDAK TERLALU BESAR --}}
...
<div class="finance-panel" style="background: white; border-radius: 20px; padding: 15px; box-shadow: 0 4px 15px rgba(0,0,0,0.08);">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; background-color: #F3E8FF; padding: 12px 25px; border-radius: 15px; margin-bottom: 20px;">
        <h2 style="font-size: 16px; font-weight: 700; color: #111827; margin: 0;">Rincian Keuangan Terakhir</h2>
        @if($role !== 'tentor')
            <a href="{{ route($role . '.laporan-keuangan') }}" style="color: #4F46E5; text-decoration: none; font-weight: 700; font-size: 13px;">Lihat Semua</a>
        @endif
    </div>

    <div style="display: flex; flex-direction: column; gap: 8px;">
        <div style="display: flex; justify-content: space-between; align-items: center; padding: 12px 20px; background: #60A060; color: white; border-radius: 12px;">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; padding: 12px 20px; background: #D74E4E; color: white; border-radius: 12px;">
